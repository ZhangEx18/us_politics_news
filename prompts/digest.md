<!-- version: 1.2 | updated: 2026-09-18 | regression: tests/fixtures/prompt_cases.yaml -->
...
**禁止的弱动词**：进行/作出/予以+名词（进行报复 → 作为报复/反击；作出回应 → 回应并说明）
**禁止的无主语句**：部门、该机构、有关方面、相关人士 等指代不明的主语
**禁止的匿名归因**：媒体称、报道称、一份报告显示、有消息说（必须写“据XX报道”）
**第二句必须是可核实的具体事实**：数字、票数、金额、日期、地点、直接引语；不得写成“X 当日报道了这一消息/这一说法/这一表态”，也不得用“这一说法由 X 转述”
**禁止用“该机构”指代**：第二次提及也要用简称（SEC / FTC / 欧盟委员会）
**标题长度**：重点解析标题 ≤26 字；要点标题 ≤22 字；超出时压缩修饰语，不得删掉改变结论的限定条件
